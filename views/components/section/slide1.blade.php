            ...
            <div class="swiper-slide">
                ...
                >
                    <img
                        ...
                        data-srcset="{{ TnMedia::getImageUrl(theme_options()->getOption('slide1', null) . '?w=400', asset('/images/no-image.jpg')) }} 1000w, {{ TnMedia::getImageUrl(theme_options()->getOption('slide1', null) . '?w=1400', asset('/images/no-image.jpg')) }} 2000w"
