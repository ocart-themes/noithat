<section class="hidden lg:block section-custom sec-about antialiased font-sans">
    <div class="hidden sec-heading text-center max-w-3xl mx-auto px-4 sm:px-6 mb-4">
        <h2 class="text-xl md:text-2xl font-bold mb-2">ShopMen thời trang giới trẻ</h2>
        <p class="text-gray-600">Chuyên sản xuất buôn bán các sản phẩm thời trang tốt nhất dành cho giới trẻ.</p>
    </div>
                ...
                <div class="middle-icon-features-item text-center mt-4">
                    ...
                    <div class="middle-icon-features-content pt-4">
                        ...
                        <p class="text-gray-500">
                            Chúng tôi tin tưởng sẽ làm hài lòng quý khách hàng sử dụng sản phẩm của chúng tôi.
                        </p>
                    </div>
                </div>
            </div>
